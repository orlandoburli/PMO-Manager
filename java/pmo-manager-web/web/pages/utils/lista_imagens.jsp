...
<script type="text/javascript">
	...
	$("#listaImagensUpload").click(function(e) {
		$("#tabEnviarImagens").load("listaimagem.upload.action");
	...
	function loadImagens() {
		$("#tabListaImagens").load("listaimagem.datatable.action", function(response, status, xhr) {
	...
	function loadClickFunction() {
		console.log("load click function");
		
		$(".BotaoRetornarImagem").click(function(e) {
			console.log("Clique botao retornar imagem");
