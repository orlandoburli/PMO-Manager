...
<body class="sidebar-wide page-condensed">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div id="formulario-home" class=".conteudo-home">
...
<body class="page-header-fixed page-quick-sidebar-over-content ">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="index.html"> <img
					src="<%=request.getContextPath() %>/web/assets/admin/layout/img/logo.png" alt="logo"
					class="logo-default" />
				</a>
				...
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 250px;">
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar2.jpg" alt="" />
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar3.jpg" alt="" />
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar1.jpg" alt="" />
					...
					<li class="dropdown dropdown-user"><a href="#"
						...
						data-hover="dropdown" data-close-others="true"> <img alt=""
							class="img-circle"
							src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar3_small.jpg" /> <span
							...
							<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar3.jpg" alt="...">
									...
									<li class="media"><img class="media-object"
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar1.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar4.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar2.jpg" alt="...">
										<div class="media-body">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar6.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar7.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar8.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar9.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar10.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar11.jpg" alt="...">
										<div class="media-body">
									...
									<div class="page-quick-sidebar-chat-user-messages">
										<div class="post out">
											<img class="avatar" alt=""
												src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar3.jpg" />
											<div class="message">
										...
										<div class="post in">
											<img class="avatar" alt=""
												src="<%=request.getContextPath() %>/web/assets/admin/layout/img/avatar2.jpg" />
											<div class="message">
	...
	<!-- BEGIN CORE PLUGINS -->
	<!--[if lt IE 9]>
<script src="<%=request.getContextPath() %>/web/assets/global/plugins/respond.min.js"></script>
<script src="<%=request.getContextPath() %>/web/assets/global/plugins/excanvas.min.js"></script> 
<![endif]-->
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery-1.11.0.min.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery-migrate-1.2.1.min.js"
		type="text/javascript"></script>
	<!-- IMPORTANT! Load jquery-ui-1.10.3.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
	<script
		src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/bootstrap/js/bootstrap.min.js"
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath() %>/web/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery.blockui.min.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/jquery.cokie.min.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/plugins/uniform/jquery.uniform.min.js"
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath() %>/web/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js"
		type="text/javascript"></script>
	<!-- END CORE PLUGINS -->
	<script type="text/javascript"
		src="<%=request.getContextPath() %>/web/assets/global/plugins/select2/select2.min.js"></script>
	<script src="<%=request.getContextPath() %>/web/assets/global/scripts/metronic.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/admin/layout/scripts/layout.js"
		type="text/javascript"></script>
	<script src="<%=request.getContextPath() %>/web/assets/admin/layout/scripts/quick-sidebar.js"
		type="text/javascript"></script>
	<script>
